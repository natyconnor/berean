...
export function validateVerseRefBounds(ref: VerseRefLike): VerseRefBoundsValidation {
...
export function getVerseRefBoundsErrorMessage(ref: VerseRefLike): string | null {
